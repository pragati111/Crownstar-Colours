...
const users = [
  { title: "Damp Proof Paint", details: { secondary: "", text: "Excellent waterproofing solution that seals and waterproofs fine cracks and porous plaster,\nSolar Reflectance Index : 107,\nPercent Elongation : 300,\n7 years warranty", image: bucket_dpp }},
  { title: "Wall Filler", details: { secondary: "", text: "Enhances durability and provides excellent long lasting foundation base increasing wall life", image: wall_filler }},
  { title: "Wood Polish", details: { secondary: "", text: "Enhances wood beauty with lacquer, PU, melamine & duco finishes for doors, windows, and furniture", image: wood_polish }},
  { title: "Wall Primer", details: { secondary: "", text: "Ensures better cohesiveness and excellent adhesion of finish coats before final application", image: wall_primer }},
  { title: "Ultimo Shine", details: { secondary: "", text: "Radiates higher sheen with smooth silky finish and unique anti-bacterial shield for walls,\nScratch Resistant,\nEquivalent to Royale Shine,\n8 yrs warranty", image: ultimo_shine }},
  { title: "Premium Acrylic Emulsion", details: { secondary: "", text: "Gives rich matte finish and designed to prevent fungal growth on walls with durability,\nVarieties -- Matt and Gloss,\n5 yrs warranty", image: premium_acrylic_emulsion }},
  { title: "Heat Resistant Paint", details: { secondary: "", text: "Ensures excellent heat protection, drop in room temperature & provides power saving benefits,\nSRI value -- 110,\nBased on Nano Technology,\n7 yrs warranty", image: heat_resistant_paint }},
  { title: "UV Paint for Exterior", details: { secondary: "", text: "Protects against sunlight and rain water degradation with thermal barrier technology,\nVarities - Matt and Finish,\nScratch Resistant,\nUV protection", image: uv_paint_for_exterior }},
  { title: "Acrylic Bond Distemper", details: { secondary: "", text: "Wide coverage area ensuring good opacity and delivers tough durable economical interior solutions,\n2 yrs warranty", image: acrylic_bond_distemper }},
  { title: "Floor Coating", details: { secondary: "", text: "High-build durable product with excellent gloss, color retention and mechanical strength for industrial floors", image: floor_coating }},
  { title: "Synthetic Enamel", details: { secondary: "", text: "Solvent-based paints with superior mirror gloss finish applicable on metal, wall & wood surfaces", image: synthetic_enamel }},
];
...
const FlipCards = () => {
  ...
  const showDetails = contextSafe((card) => {
    ...
    if (chosenImg.complete) onLoad();
    else chosenImg.addEventListener("load", onLoad);
  ...
  const hideDetails = contextSafe(() => {
    ...
    gsap.timeline()
      .to(chosenDetailsRef.current, { xPercent: -100, duration: 0.5 })
      .to(cards, { opacity: 1, duration: 0.5 }, "<");

    Flip.from(state, { scale: true, duration: 0.5 })
    ...
    <div className="app" ref={appRef}>
      ...
      <div className="chosen" ref={chosenRef}>
        ...
        <div className="chosen__details" ref={chosenDetailsRef}>
          ...
          <div className="chosen__details__description" ref={chosenDescriptionRef} />
        </div>
      </div>
    </div>
  );
